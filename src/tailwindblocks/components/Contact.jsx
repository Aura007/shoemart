   ...
   <section>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
            <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-indigo-500 shadow-sm">
            ...
            <a href="#" class="mt-4 inline-block text-base font-semibold text-indigo-500">sales@shoemart.com</a>
            </div>
        </div>
        <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
            <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-indigo-500 shadow-sm">
            ...
            <a href="#" class="mt-4 inline-block text-base font-semibold text-indigo-500">support@shoemart.com</a>
            </div>
        </div>
        <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
            <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-indigo-500">
            <svg class="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <a href="#" class="mt-4 inline-block text-base font-semibold text-indigo-500">Get directions</a>
            </div>
        </div>
        <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
            <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-indigo-500 shadow-sm">
            ...
            <a href="#" class="mt-4 inline-block text-base font-semibold text-indigo-500">+1 (555) 123-4567</a>
            </div>
        </div>
        </div>
    </div>
